...
├── docs/                         数据来源文档与示例截图
│   ├── 国家标准人工智能-大模型选型和应用指南.pdf   GB/Z 201—2026 原文
│   ├── GBZ201-2026-全文OCR.txt                  PDF 全文 OCR 文本
...
- **算力 / 数据公式与表格**：GB/Z 201—2026《人工智能 大模型选型和应用指南》附录 A。关键数值已与 PDF 原文核对（核实日期 2026-09-09）。
