...
window.__DATA__ = {
  ...
  models: [
    ...
    { id: 'deepseek-v3', name: 'DeepSeek-V3',  vendor: '深度求索', params_b: 671,  active_b: 37, oss: true,  overseas: false, ctx_k: 128, multimodal: false, filing: '已备案', source: '官方技术报告（MoE 总参数 671B，激活约 37B）', checked_at: '2026-09-09' },
    { id: 'deepseek-r1', name: 'DeepSeek-R1',  vendor: '深度求索', params_b: 671,  active_b: 37, oss: true,  overseas: false, ctx_k: 128, multimodal: false, filing: '已备案', source: '官方技术报告（MoE 总参数 671B，激活约 37B）', checked_at: '2026-09-09' },
